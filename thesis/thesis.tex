...
software development paradigms like \gls{ttd} can encourage software developers to increase the test coverage and implement only necessary features.



Surprisingly, these requirements are very similar to the supply chain security efforts in Cloud-Native. \gls{slsa} assigns the same constraints to a software supply chain.
Binary reproducibility is another important factor in the \gls{slsa} specification. While strict binary reproducibility is not being mandated by the \gls{do178c} certification, it definitely ensures deterministic builds. Deterministic builds are a strict
requirement of \gls{do178c}.
