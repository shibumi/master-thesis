...
possess multiple processing units. Each processing unit is comparable to a dedicated computer with its own hardware and operating system. These processing units
...
Another important factor of avionic hosted functions hosted in flight cabinets is that they differ in reliability requirements. For example
