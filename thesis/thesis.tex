...
Spatial isolation through \gls{ram} may be not enough, it would be useful to provide \gls{cpu} pinning, too. \gls{cpu} pinning allows giving a process isolated access to a \gls{cpu} core. This way it is possible to run applications
