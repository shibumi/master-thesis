...
with a custom \glsfirst{cni} plugin called \emph{calico}: \emph{minikube start --cpus 4 --memory 4096 --vm --cni=calico}. \emph{Calico} is needed, because the default KubeProxy components provides no network isolation
