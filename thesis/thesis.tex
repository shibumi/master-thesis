...
Lines 11-19 defines an egress rule for all namespaces to the pod that matches the labels \emph{k8s-app: kube-dns} on port 53 and protocol \gls{udp}, allowing only \gls{dns} traffic. \autoref{curlfailure} reports the result
