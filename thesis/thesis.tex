...
successfully attacked package managers via hosting malicious package mirrors\cite{cappos2008look}\cite{GoogleSecurityBlog}. The last possible weak point is the user. An attacker is able to exploit the fact that a human user or developer might make mistakes.
...
the software. The name of this method is called typosquatting and a good example for this is one incident with the heavily used Javascript package manager npm\cite{Typosquatting}\cite{GoogleSecurityBlog}.
