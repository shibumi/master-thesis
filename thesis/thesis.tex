...
such like socket connections, system calls (syscalls) or kernel permission delegations.
...
The following sections will examine the differences between containers and pods and analyze Kubernetes' architecture.
