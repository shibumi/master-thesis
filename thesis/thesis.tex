...
in the fuselage\cite{mccabe2009avionics}. This possible increase of cable length can be prevented via using ideas from the federated avionics and the \gls{ima}.
...
in the plane's fuselage. This way it is possible to successfully exploit the advantages of the integrated architecture, while achieving
...
for creating synergies between these two areas and applying cloud computing ideas in \gls{dima}.
